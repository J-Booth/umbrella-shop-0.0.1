...
class OrderPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.l_green_price.grid(row=16, column=6, columnspan=3, pady=10)
        ...
        self.l_green_amount.grid(row=16, column=10, columnspan=2, pady=10)
        ...
        self.d_grey_price.grid(row=18, column=6, columnspan=3, pady=10)
        ...
        self.d_grey_amount.grid(row=18, column=10, columnspan=2, pady=10)
        ...
        self.cart_button.grid(row=21, column=10, columnspan=4, sticky="W",
                              pady=5)
...
-----------------------------------
    ...
    def confirm(self, P, S, field_type):
        ...
        if isinstance(inserted_value, int) and 1 <= len(allowed_value) <= 4:
            ...
            # type(self.final_cost_label.cget("text")))
